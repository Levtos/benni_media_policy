...
def decide_action(
    ...
    if homepods_missing:
        ...
        if inp.bio_sleep:
            ...
            # Keine Pause-Erinnerung (Kalt-Idle) → nichts zu resumen. Der Stream
            # überlebt Neustarts jetzt am Ursprung (media_apply v0.15.2 pausiert
            # nicht mehr auf presence_unknown), daher kein Baseline-Auto-Start
            # mehr — Musik startet über echte Trigger (Wecken/Heimkehr/TV-aus).
